...
//        }
    ...
    public static File downloadBitmap(Context context, String urlString) {
        ...
        Utility.disableConnectionReuseIfNecessary();
        ...
        try {
            ...
            final InputStream in =
                    new BufferedInputStream(urlConnection.getInputStream(), Constants.IO_BUFFER_SIZE);
            out = new BufferedOutputStream(new FileOutputStream(cacheFile), Constants.IO_BUFFER_SIZE);
