 ...
 * About screen present inside the settings menu.
 ...
 */
@TargetApi(11)
public class AboutScreenFragmentActivity extends BaseActivity {
	...
	public void onStart() {
		...
		/**
		 * This is done as we are applying grey background to the webview.
		 * When the user over scrolls the webview, it shows white background.
		 * The over scrolling feature is available from sdk version 11 hence the check. 
		 */
